    ...
    <img
        ...
        <div className="text-center  w-1/2">
          <h1 className="text-6xl font-bold">
            <span className="text-5xl font-bold text-green-600">HeartAttack Patients</span>
          </h1>
